...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1 = findViewById(R.id.firstText);
        textView2 = findViewById(R.id.secondText);
        textView3 = findViewById(R.id.thirdText);
        textView4 = findViewById(R.id.forthText);
        searchView = findViewById(R.id.searchView);

        // Load Animations
        anim_from_bottom = AnimationUtils.loadAnimation(this, R.anim.anim_from_bottom);
        anim_from_top = AnimationUtils.loadAnimation(this, R.anim.anim_from_top);
        anim_from_bottom = AnimationUtils.loadAnimation(this, R.anim.anim_from_left);
        ...
        textView1.setAnimation(anim_from_top);
